...
CREATE TABLE `goods`  (
  ...
  `shouzhi` int(0) NOT NULL COMMENT '仓库',
...
INSERT INTO `menu` VALUES (3, '003', '仓库管理', '1', NULL, 'Storage', '0,1', 'shouzhi/StorageManage', 'el-icon-office-building');
...
INSERT INTO `menu` VALUES (6, '006', '记录管理', '1', NULL, 'Record', '0,1,2', 'record/RecordManage', 'el-icon-s-userPaidOrder');
...
-- Records of shouzhi
-- ----------------------------
INSERT INTO `shouzhi` VALUES (1, '日用品仓库', '用于存放日用品');
INSERT INTO `shouzhi` VALUES (2, '数码仓库', '用于存放数码产品');
INSERT INTO `shouzhi` VALUES (3, '食品仓库', '用于存放食品');
INSERT INTO `shouzhi` VALUES (4, '冷冻仓库', '用于存放冷冻食品');
INSERT INTO `shouzhi` VALUES (5, '果蔬仓库', '用于存放水果和蔬菜');
INSERT INTO `shouzhi` VALUES (6, '服装仓库', '用于存放服装');
INSERT INTO `shouzhi` VALUES (7, '水产仓库', '用于存放水产品');
